...
const DICT = {
  en: {
    ...
    'soundtrack.provider_label': 'Engine',
    'soundtrack.provider_minimax': 'MiniMax',
    'soundtrack.provider_senseaudio': 'SenseAudio',
    ...
    'settings.audio.subtitle': 'API keys for soundtrack generation (background music + narration).',
    'settings.audio.provider_minimax': 'MiniMax · music + voice',
    'settings.audio.provider_senseaudio': 'SenseAudio · voice',
    ...
    'settings.audio.api_key_placeholder_sense': 'Paste your SenseAudio API key',
    ...
    'settings.audio.not_configured': 'No API key configured yet.',
    ...
    'settings.audio.hint_sense': 'Stored locally in .html-video/media-config.json. SenseAudio powers narration only (background music coming soon). Get a key at senseaudio.cn; the default endpoint is api.senseaudio.cn.',
  ...
  zh: {
    ...
    'settings.audio.provider_minimax': 'MiniMax · 音乐 + 配音',
    'settings.audio.provider_senseaudio': 'SenseAudio · 配音',
    'settings.audio.loading': '检查中…',
    'settings.audio.api_key': 'API key',
    'settings.audio.api_key_placeholder': '粘贴你的 MiniMax API key',
    'settings.audio.api_key_placeholder_sense': '粘贴你的 SenseAudio API key',
    ...
    'settings.audio.not_configured': '尚未配置 API key。',
    ...
    'settings.audio.hint_sense': '保存在本地 .html-video/media-config.json。SenseAudio 仅用于旁白配音（背景音乐 coming soon）。到 senseaudio.cn 申请 key；默认接口为 api.senseaudio.cn。',
