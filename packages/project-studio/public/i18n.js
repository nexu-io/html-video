...
const DICT = {
  en: {
    ...
    'settings.agent.byok.intro': 'Use your own API key. Reads from environment:',
    'settings.agent.byok.anthropic_header': 'Anthropic / OpenRouter',
    ...
    'settings.agent.byok.openai_header': 'OpenAI-compatible',
    'settings.agent.byok.openai_key': 'OPENAI_API_KEY',
    'settings.agent.byok.openai_base': 'OPENAI_BASE_URL (optional, defaults to api.openai.com)',
    'settings.agent.byok.openai_model': 'HV_AGENT_MODEL (optional, defaults to gpt-4o-mini)',
  ...
  zh: {
    ...
    'settings.agent.byok.intro': '填入自己的 API Key，从环境变量读：',
    'settings.agent.byok.anthropic_header': 'Anthropic / OpenRouter',
    ...
    'settings.agent.byok.openai_header': 'OpenAI 兼容',
    'settings.agent.byok.openai_key': 'OPENAI_API_KEY',
    'settings.agent.byok.openai_base': 'OPENAI_BASE_URL（可选，默认 api.openai.com）',
    'settings.agent.byok.openai_model': 'HV_AGENT_MODEL（可选，默认 gpt-4o-mini）',
